...
const Speaking = () => {
  ...
  const onTaptoSpeakClick = useCallback(() => {
    navigate("/main");
  }, [navigate]);
          ...
          <div className={styles.groupParent6}>
            ...
            <div className={styles.rectangleParent11}>
              ...
              <div className={styles.iconMicParent}>
                <img className={styles.iconMic} alt="" onClick={onTaptoSpeakClick} src="/-icon-mic.svg" />
                <div className={styles.rectangleParent12}>
                  <div className={styles.groupChild25} />
                  <div className={styles.tapToSpeak} onClick={onTaptoSpeakClick}>Tap to speak</div>
                </div>
              </div>
            </div>
          </div>
